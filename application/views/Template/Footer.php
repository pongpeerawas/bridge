...
<script src="<?php echo base_url('assetAdmin/js/fullcalendar.min.js') ?>"></script>
<script src="<?php echo base_url('assetAdmin/js/matrix.js') ?>"></script>
<script src="<?php echo base_url('assetAdmin/js/matrix.dashboard.js') ?>"></script>
<script src="<?php echo base_url('assetAdmin/js/jquery.gritter.min.js') ?>"></script>
<script src="<?php echo base_url('assetAdmin/js/matrix.interface.js') ?>"></script>
<script src="<?php echo base_url('assetAdmin/js/matrix.chat.js') ?>"></script>
<script src="<?php echo base_url('assetAdmin/js/jquery.validate.js') ?>"></script>
<script src="<?php echo base_url('assetAdmin/js/matrix.form_validation.js') ?>"></script>
<script src="<?php echo base_url('assetAdmin/js/jquery.wizard.js') ?>"></script>
...
<script src="<?php echo base_url('assetAdmin/js/js/bootstrap-select.js') ?>"></script>
