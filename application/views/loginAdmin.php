...
<body>
  ...
  <div id="loginbox">
    <!-- <form id="loginform" class="form-vertical"  method="post"  action="loginAdmin/login"> -->
      <div class="control-group normal_text"> <h3><img src="../assetAdmin/img/icons/32/home.png"/>  ระบบจัดการหอพักน้องจุม  (พนักงาน)</h3></div>
      <?= validation_errors() ?>
      ...
      <div class="form-actions">
        ...
        <span class="pull-left"><a href="<?php echo site_url('login'); ?> " class="flip-link btn btn-info" id="to-recover"> < กลับ</a></span>
