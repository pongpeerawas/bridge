...
<head>
  <title>ระบบจัดการหอพักน้องจุม</title><meta charset="UTF-8" />
  ...
  <link href="<?php echo base_url('assetAdmin/css/matrix-login.css') ?>" rel="stylesheet" />
...
<body>
  ...
  <div id="loginbox">
    <!-- <form id="loginform" class="form-vertical"  method="post"  action="loginAdmin/login"> -->
      <div class="control-group normal_text"> <h3><img src="../assetAdmin/img/icons/32/home.png"/>  ระบบจัดการหอพักน้องจุม</h3></div>
      <?= validation_errors() ?>
      ...
      <div class="control-group">
        <label>
            &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;    &nbsp; &nbsp;  &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;  &nbsp; &nbsp;&nbsp; &nbsp;  ไม่มีบัญชีผู้ใช้งาน?
          &nbsp; &nbsp; <a href="<?php echo site_url('renter/register_form'); ?>"><strong style="color:Red"><U>ลงทะเบียน</U></strong></a>
        </label>
        <BR>
          <BR>
        ...
        <div class="controls">
          <div class="main_input_box">
            <span class="add-on bg_lg"><i class="icon-user"> </i></span> <input type="text" name="username" class="form-control" id="txtUsername" placeholder="Username" required>
      ...
      <div class="control-group">
        <div class="controls">
          <div class="main_input_box">
            <span class="add-on bg_ly"><i class="icon-lock"></i></span>  <input type="password" name="password" class="form-control" id="txtPassword" placeholder="Password" required>
          </div>
        </div>
      </div>
      <div class="form-actions">
        <span class="pull-left"><a href="<?php echo site_url('login/Show_login_admin'); ?> " class="flip-link btn btn-info" id="to-recover">ผู้ดูแลระบบ</a></span>
        <!-- <span class="pull-right"><a type="submit" class="btn btn-success" /> เข้าสู่ระบบ</a></span> -->

        <span class="pull-right">  <button type="submit" class="btn btn-primary">เข้าสู่ระบบ</button></span>
...
<script src="<?php echo base_url('assetAdmin/js/matrix.login.js') ?>"></script>
